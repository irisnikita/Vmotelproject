                    ...
                    isLoadingHome ? <div className='background-loading'><SmileOutlined style={{fontSize: 50}} className='animated bounce infinite ' /> Loading...</div> :   
                        <div className='intro-page'>
                            <Row style={{display: 'flex', alignItems: 'center'}}>
                                <Col xs={{span: 24, offset: 0}} md={{span: 8, offset: 4}} style={{padding: '0px 10px'}} >
                         ...
                         Dùng thử miễn phí
                                ...
                                <Col xs={{span: 24, offset: 0}} md={{span: 8, offset: 2}} style={{padding: '0px 10px'}}>
                                    <ScrollAnimation animateIn='fadeInRight'>
                                        <img className='image-logo-hero' src={hero_right} width='500px' />
                                    </ScrollAnimation>
                                </Col>
                            </Row>
                            <ScrollAnimation animateIn='bounceInLeft' >
                                <Row style={{marginTop: 100, alignItems: 'center', display: 'flex', flexDirection: 'column'}}>
                                    ...
                                    <Col xs={{span: 24, offset: 0}} md={{span: 18}} style={{padding: '0px 10px'}}>
